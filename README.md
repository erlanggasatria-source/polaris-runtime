...
| Demo | Framework | URL |
| :--- | :--- | :--- |
| Meeting App | **React** | [`polaris-runtime.my.id/react/`](https://polaris-runtime.my.id/react/) |
| Meeting App | **Vue** | [`polaris-runtime.my.id/vue/`](https://polaris-runtime.my.id/vue/) |
| Meeting App | **Angular** | [`polaris-runtime.my.id/angular/`](https://polaris-runtime.my.id/angular/) |
| Meeting App | **Svelte** | [`polaris-runtime.my.id/svelte/`](https://polaris-runtime.my.id/svelte/) |
| Meeting App | **Solid** | [`polaris-runtime.my.id/solid/`](https://polaris-runtime.my.id/solid/) |
| Meeting App | **Vanilla JS** | [`polaris-runtime.my.id/vanilla/`](https://polaris-runtime.my.id/vanila/) |

> All six frameworks use the **exact same plugins**. Only the UI changes.

---

## 📚 Examples & Tutorials

Progressive examples — from a single plugin to a full AI-built UI:

- [01 Basic Note](https://polaris-runtime.my.id/basic-note/) — Single plugin, capability orchestration.
- [02 Note Guard](https://polaris-runtime.my.id/guard-note/) — OOP domain model + `allowed` guards.
- [03 Meeting Notes](https://polaris-runtime.my.id/basic-meeting/) — Full state machine, role-based permissions.
- [04 LLM-built UI](https://polaris-runtime.my.id/new-meeting/) — UI generated by an LLM from the same plugin.
